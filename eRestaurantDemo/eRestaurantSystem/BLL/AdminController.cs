...
namespace eRestaurantSystem.BLL
{
    ...
    public class AdminController
    {
        ...
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public List<eRestaurantSystem.DAL.DTOs.CategoryMenuItems> GetCategoryMenuItems_List()
        {
            using (var context = new eRestaurantContext())
            {
                //query syntax
        ...
        public List<ReservationCollection> ReservationsByTime(DateTime date)
        {
            using (var context = new eRestaurantContext())
            {
                ...
                //Linq to Entity will only execute the query when it deems necessary for having the results in memory.
                //to get your query to execute and have the resulting data inside memory for further use, you can attach the .ToList() to the previous query
                    
                //note: the second query is NOT using an Entity. It is using the results from a previous query

                //itemGroup is a temporary in memory data collection. This collection can be used in selecting your final data collection
